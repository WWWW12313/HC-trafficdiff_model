...
def run_sampling(
    ...
    if macro_guidance_scale != 0.0 and diffusion.macro_group_indices is not None:
        ...
        if group_means_path.exists():
            ...
            print(f"[macro_guidance] scale={macro_guidance_scale}, groups={len(diffusion.macro_guidance_group_means)}, start_step={diffusion.macro_guidance_start_step}")
        else:
