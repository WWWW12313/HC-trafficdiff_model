#!/usr/bin/env python
"""Run adaptive guidance sampling for macro_sparse_anneal_v2 on 2025 data."""
import sys
import os
...
if __name__ == "__main__":
    print("[run] Starting adaptive guidance sampling...")
    run_sampling(
        ...
        batch_size=500,
        device="cuda:0",
        output_csv="results/synthetic/transfer_2025_macro_sparse_adaptive_g05_uniform5k.csv",
        do_postprocess=True,
        ...
        macro_guidance_mode="adaptive",
        macro_guidance_adaptive_drift_threshold=2.0,
    )
    print("[run] Adaptive guidance sampling complete.")
